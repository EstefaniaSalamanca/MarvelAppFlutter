...
class ApiService {
  ...
  Future<Character> fetchCharacterbyName(String query) async {
    final response = await http.get(Uri.parse(
        'https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=$query&limit=99&&ts=1&apikey=4dc1b141446d7991b4e54a55fc103bf7&hash=710b5b7151872e980d79f983bcb6331d'));
